...
import { ButtonBackgroundDiv } from "@/components/Button/button.styles";
...
const CheckboxLayout: React.FC<CheckboxLayoutProps> = ({
  choices = [],
  buttonText,
  chatResponse,
  setChatMessage,
  ...
  const handleClick = async () => {
    ...
    const include = indexes.map((index) => choices[index as number]);
